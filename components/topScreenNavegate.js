...
export default function NavegateTopScreen(props) {
    ...
    return (
        <>
            <View style={{ width: "100%", paddingHorizontal: 10, paddingVertical: 13, display: props.display ? props.display : "flex", flexDirection: "row", justifyContent: "space-between", backgroundColor: props.backgroundColor }}>
