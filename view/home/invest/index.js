...
export default function Invest(props) {
  return (
    <SafeAreaView>
      ...
      <View style={{ padding: 20, width: dimensions.width, height: dimensions.height, display: "flex", flexDirection: "column", justifyContent: "space-between", marginTop: 60 }}>
        ...
        <TouchableOpacity onPress={(() => console.log("teste"))} style={{ alignSelf: "center", alignItems: "center", width: "99%", marginBottom: 80, borderRadius: 50, backgroundColor: "#8734c7", padding: 15 }}>
